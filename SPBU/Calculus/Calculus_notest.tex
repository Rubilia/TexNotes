...
{\hfill \textit{26.11.2021}}

$L = \lim\limits_{x \to a} \frac{P(x)}{Q(x)}, \left[\frac{0}{0}\right]$ или $\left[\frac{\infty}{\infty}\right]$\\
$L = \lim\limits_{x \to a}\frac{P(x)}{Q(x)} = \lim\limits_{x \to a}\frac{P'(x)}{Q'(x)}$\\

\vspace{.2cm}
\begin{task}[1320]
$\lim\limits_{x \to 0} \frac{tg(x)-x}{x-sin(x)}^{\left[\frac{0}{0}\right]} =
\lim\limits_{x \to 0} \frac{\frac{1}{cos^2(x)}-1}{1-cos(x)}=\lim\limits_{x \to 0}
\frac{\cancel{(1-cos(x))}(1+cos(x))}{\cancel{(1-cos(x))}cos^2(x)}=2$
\end{task}
